...
| collection_excludes      |  False   |  None   | A list of collection name patterns to exclude from schema discovery. Patterns can be exact names or use wildcards (e.g., 'user_hourly_activity*'). If this list is empty, no collections will be excluded.                                                                                                                                                                                                                                                                   |
...
| max_record_size          |  False   |  16777216 | Maximum size of a single record in bytes. Records exceeding this size will be skipped with a warning. Default is 16MB (16777216 bytes).                                                                                                                                                                                                                                                                                                                                     |
